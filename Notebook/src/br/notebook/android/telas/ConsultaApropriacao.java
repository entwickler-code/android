...
public class ConsultaApropriacao extends ListActivity {
...
//		setTitle(sp.getString("id", "") + " - " + sp.getString("nome", ""));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		horarios = montaDados(Tabelas.HORAS_INDIVIDUAIS, new String[]{"id", "horaInicio", "horaTermino", "descricao"}, 
				"descricao", String.format(Tabelas.HORAS_INDIVIDUAIS.whereSQL(), id));
		adapter = new ArrayAdapter<String>(ConsultaApropriacao.this, 
...
//	}
	...
	private void montaAlerta(String msg){
		...
		alertDialog.setTitle("Consulta Individual");
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		AlertDialog alertDialog = new AlertDialog.Builder(ConsultaApropriacao.this).create();
		...
		alertDialog.setButton("Ok", new DialogInterface.OnClickListener(){
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(horario != null){
					BancoDeDados banco = new BancoDeDados(ConsultaApropriacao.this, Tabelas.HORAS_INDIVIDUAIS, Tabelas.version);
