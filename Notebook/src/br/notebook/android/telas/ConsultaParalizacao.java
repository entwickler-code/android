...
public class ConsultaParalizacao extends ListActivity {
...
//		setTitle(sp.getString("id", "") + " - " + sp.getString("nome", ""));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		horarios = montaDados(Tabelas.HORAS_PARALIZACOES_INDIVIDUAL, new String[]{"id", "horaInicio", "horaTermino", "descricao"}, 
				"descricao", String.format(Tabelas.HORAS_PARALIZACOES_INDIVIDUAL.whereSQL(), id));
		adapter = new ArrayAdapter<String>(ConsultaParalizacao.this, 
...
//	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		AlertDialog alertDialog = new AlertDialog.Builder(ConsultaParalizacao.this).create();
		...
		alertDialog.setButton("Ok", new DialogInterface.OnClickListener(){
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(horario != null){
					BancoDeDados banco = new BancoDeDados(ConsultaParalizacao.this, Tabelas.HORAS_PARALIZACOES_INDIVIDUAL, Tabelas.version);
